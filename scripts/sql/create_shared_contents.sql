...
grant usage on schema package_shared
  to share in application package {{ package_name }};
grant select on view package_shared.contestants_view
  to share in application package {{ package_name }};
grant select on view package_shared.competitions_view
  to share in application package {{ package_name }};
grant select on view package_shared.matches_info_view
  to share in application package {{ package_name }};
grant select on view package_shared.match_details_view
  to share in application package {{ package_name }};