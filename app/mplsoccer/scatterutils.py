...
football_hexagon_vertices = np.array([[-0.22499999999999998, -0.3096859321060139],
                                      ...
                                      [-0.00000000000000005551115123125783,
                                          0.7327928637584178],
                                      [0.00000000000000013877787807814457,
                                          0.3827928637584179],
...
football_pentagon_vertices = np.array([[0.000000000000000023439302766909766, 0.38279286375841787],
                                       ...
                                       [0.36405764746872626, 0.11828950022680493],
                                       [0.2120288237343632, 0.28054118199261147],
                                       [0.00000000000000011719651383454883,
                                           0.38279286375841787],
                                       [0.00000000000000011719651383454883,
                                           0.38279286375841787],
                                       [0.43072483830236563, -0.5928418801372455],
...
football_hexagon_marker = mpath.Path(
    football_hexagon_vertices, football_hexagon_codes)
football_pentagon_marker = mpath.Path(
    football_pentagon_vertices, football_pentagon_codes)
...
football_left_boot_marker = mpath.Path(
    football_left_boot_vertices, football_boot_codes)
football_right_boot_marker = mpath.Path(
    football_boot_vertices, football_boot_codes)
...
football_shirt_marker = mpath.Path(
    football_shirt_vertices, football_shirt_codes)
