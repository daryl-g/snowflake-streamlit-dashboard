...
def _grid_dimensions(ax_aspect=1, figheight=9, nrows=1, ncols=1,
    ...
    if (nrows > 1) and (ncols > 1):
        ...
        dimensions['spacewidth'] = dimensions['spaceheight'] * \
            figheight / dimensions['figwidth']
        ...
        dimensions['figwidth'] = figheight * grid_height / \
            grid_width * (space + ax_aspect * ncols)
        ...
        dimensions['figwidth'] = figheight * \
            grid_height * ax_aspect / grid_width
        dimensions['spaceheight'] = 0
        dimensions['spacewidth'] = 0
        dimensions['axheight'] = grid_height

    dimensions['axwidth'] = dimensions['axheight'] * \
        ax_aspect * figheight / dimensions['figwidth']
...
def _draw_grid(dimensions, left_pad=0, right_pad=0, axis=True, grid_key='grid'):
    ...
    grid_bottom = dims['bottom'] + \
        dims['endnote_height'] + dims['endnote_space']
