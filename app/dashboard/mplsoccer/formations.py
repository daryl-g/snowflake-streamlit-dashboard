    ...
    def __post_init__(self):
        ...
        self.formations = {
            '442': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1, wyscout='gk'),
                    Position('RB', self.position_line4.RB,
                             statsbomb=[2], opta=2, wyscout='rb'),
                    Position('RCB', self.position_line4.RCB,
                             statsbomb=[3], opta=5, wyscout='rcb'),
                    Position('LCB', self.position_line4.LCB,
                             statsbomb=[5], opta=6, wyscout='lcb'),
                    Position('LB', self.position_line4.LB,
                             statsbomb=[6], opta=3, wyscout='lb'),
                    ...
                    Position('RCF', self.position_line4.RCF,
                             statsbomb=[22], opta=10, wyscout='ss'),
                    Position('LCF', self.position_line4.LCF,
                             statsbomb=[24], opta=9, wyscout='cf'),
                    ],
            '41212': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1),
                      ...
                      Position('RCM', self.position_line5.RCM,
                               statsbomb=[13, 12], opta=7),
                      Position('LCM', self.position_line5.LCM,
                               statsbomb=[15, 16], opta=11),
                      Position('CAM', self.position_line5.CAM,
                               statsbomb=[19, 25], opta=8),
                      Position('RCF', self.position_line4.RCF,
                               statsbomb=[22], opta=10),
                      Position('LCF', self.position_line4.LCF,
                               statsbomb=[24], opta=9),
                      ],
            ...
            '4411': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1, wyscout='gk'),
                     ...
                     Position('ST', self.position_line5.ST,
                              statsbomb=[23], opta=9, wyscout='cf'),
                     ],
            ...
            '532': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1, wyscout='gk'),
                    Position('RB', self.position_line5.RB, statsbomb=[
                             2, 7], opta=2, wyscout='rb5'),
                    Position('RCB', self.position_line5.RCB,
                             statsbomb=[3], opta=6, wyscout='rcb3'),
                    Position('CB', self.position_line5.CB,
                             statsbomb=[4], opta=5, wyscout='cb'),
                    Position('LCB', self.position_line5.LCB,
                             statsbomb=[5], opta=4, wyscout='lcb3'),
                    Position('LB', self.position_line5.LB, statsbomb=[
                             6, 8], opta=3, wyscout='lb5'),
            ...
            '3142': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1),
                     ...
                     Position('CDM', self.position_line5.CDM,
                              statsbomb=[10], opta=8),
                     Position('RM', self.position_line4.RM,
                              statsbomb=[12], opta=2),
                     Position('RCM', self.position_line4.RCM,
                              statsbomb=[13], opta=7),
                     Position('LCM', self.position_line4.LCM,
                              statsbomb=[15], opta=11),
                     Position('LM', self.position_line4.LM,
                              statsbomb=[16], opta=3),
                     Position('RCF', self.position_line5.RCF,
                              statsbomb=[22], opta=9),
                     Position('LCF', self.position_line5.LCF,
                              statsbomb=[24], opta=10),
                     ],
            ...
            '4132': [Position('GK', self.position_line5.GK, statsbomb=[1], opta=1, wyscout='gk'),
                     ...
                     Position('LW', self.position_line4.LW, statsbomb=[21, 16], opta=11,
                              wyscout='lamf'),
                     Position('RCF', self.position_line5.RCF,
                              statsbomb=[22], opta=9, wyscout='ss'),
            ...
            '32221': [Position('GK', self.position_line5.GK, statsbomb=[1]),
                      ...
                      Position('LM', self.position_line5.LM,
                               statsbomb=[16, 15]),
                      Position('RAM', self.position_line4.RAM,
                               statsbomb=[18, 17]),
                      Position('LAM', self.position_line4.LAM,
                               statsbomb=[20, 21]),
            ...
            '3232': [Position('GK', self.position_line5.GK, statsbomb=[1], wyscout='gk'),
                     Position('RCB', self.position_line5.RCB,
                              statsbomb=[3], wyscout='rcb3'),
                     Position('CB', self.position_line5.CB,
                              statsbomb=[4], wyscout='cb'),
                     Position('LCB', self.position_line5.LCB,
                              statsbomb=[5], wyscout='lcb3'),
                     Position('RWB', self.position_line5.RWB,
                              statsbomb=[7], wyscout='rdmf'),
                     Position('LWB', self.position_line5.LWB,
                              statsbomb=[8], wyscout='ldmf'),
                     Position('RCM', self.position_line5.RCM,
                              statsbomb=[13], wyscout='ramf'),
                     Position('CM', self.position_line5.CM,
                              statsbomb=[14], wyscout='amf'),
                     Position('LCM', self.position_line5.LCM,
                              statsbomb=[15], wyscout='lamf'),
                     Position('RCF', self.position_line5.RCF,
                              statsbomb=[22], wyscout='ss'),
                     Position('LCF', self.position_line5.LCF,
                              statsbomb=[24], wyscout='cf'),
                     ],
            '312112': [Position('GK', self.position_line5_with_ss.GK, statsbomb=[1]),
                       Position('RCB', self.position_line5_with_ss.RCB,
                                statsbomb=[3]),
                       Position('CB', self.position_line5_with_ss.CB,
                                statsbomb=[4]),
                       Position('LCB', self.position_line5_with_ss.LCB,
                                statsbomb=[5]),
                       Position('CDM', self.position_line5_with_ss.CDM,
                                statsbomb=[10]),
                       Position('RCM', self.position_line5_with_ss.RCM,
                                statsbomb=[13]),
                       Position('LCM', self.position_line5_with_ss.LCM,
                                statsbomb=[15]),
                       Position('CAM', self.position_line5_with_ss.CAM,
                                statsbomb=[19]),
                       Position('RCF', self.position_line5_with_ss.RCF,
                                statsbomb=[22]),
                       Position('LCF', self.position_line5_with_ss.LCF,
                                statsbomb=[24]),
                       Position('SS', self.position_line5_with_ss.SS,
                                statsbomb=[25]),
                       ],
            ...
            '4213': [Position('GK', self.position_line5.GK, statsbomb=[1], wyscout='gk'),
                     Position('RB', self.position_line4.RB,
                              statsbomb=[2], wyscout='rb'),
                     Position('RCB', self.position_line4.RCB,
                              statsbomb=[3], wyscout='rcb'),
                     Position('LCB', self.position_line4.LCB,
                              statsbomb=[5], wyscout='lcb'),
                     Position('LB', self.position_line4.LB,
                              statsbomb=[6], wyscout='lb'),
                     Position('RDM', self.position_line5.RDM,
                              statsbomb=[9], wyscout='rdmf'),
                     Position('LDM', self.position_line5.LDM,
                              statsbomb=[11], wyscout='ldmf'),
                     Position('CAM', self.position_line5.CAM,
                              statsbomb=[19], wyscout='amf'),
                     Position('RCF', self.position_line5.RCF,
                              statsbomb=[22], wyscout='rwf'),
                     Position('ST', self.position_line5.ST,
                              statsbomb=[23], wyscout='cf'),
                     Position('LCF', self.position_line5.LCF,
                              statsbomb=[24], wyscout='lwf'),
                     ],
