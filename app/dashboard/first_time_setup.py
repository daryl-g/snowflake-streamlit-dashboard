# This file contains the code for the reference binding page of the dashboard.
...
def request_account_privileges():
    ...
    st.button("Request Privileges",
              on_click=permission.request_account_privileges, args=[PRIVILEGES])
